...
/**
 * @file ops.hpp
 * @brief Includes supported operations for Eigen array types.
 */

#ifndef AUTODIFF_SRC_EIGEN_ARRAY_OPS_HPP
#define AUTODIFF_SRC_EIGEN_ARRAY_OPS_HPP
...
#endif // AUTODIFF_SRC_EIGEN_ARRAY_OPS_HPP
